...
public class Items {
    ...
    private final static List<Integer> fuels = Arrays.asList(new Integer[]{Material.LOG.getId(), Material.STICK.getId(), Material.SAPLING.getId(), Material.WORKBENCH.getId(), Material.CHEST.getId(), Material.COAL.getId(), Material.BOOKSHELF.getId(), Material.WOOD.getId()});
